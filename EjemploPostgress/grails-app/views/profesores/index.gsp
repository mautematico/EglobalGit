		...
		<div id="list-profesores" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="edad" title="${message(code: 'profesores.edad.label', default: 'Edad')}" />
				...
				<g:each in="${profesoresInstanceList}" status="i" var="profesoresInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${profesoresInstance.id}">${fieldValue(bean: profesoresInstance, field: "edad")}</g:link></td>
