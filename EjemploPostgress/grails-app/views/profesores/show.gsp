	...
	<body>
		...
		<div id="show-profesores" class="content scaffold-show" role="main">
			...
			<ol class="property-list profesores">
				...
				<g:if test="${profesoresInstance?.edad}">
				<li class="fieldcontain">
					<span id="edad-label" class="property-label"><g:message code="profesores.edad.label" default="Edad" /></span>
					
						<span class="property-value" aria-labelledby="edad-label"><g:fieldValue bean="${profesoresInstance}" field="edad"/></span>
