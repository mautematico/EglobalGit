	...
	<body>
		...
		<div id="show-alumnos" class="content scaffold-show" role="main">
			...
			<ol class="property-list alumnos">
				...
				<g:if test="${alumnosInstance?.apepat}">
				<li class="fieldcontain">
					<span id="apepat-label" class="property-label"><g:message code="alumnos.apepat.label" default="Apepat" /></span>
					
						<span class="property-value" aria-labelledby="apepat-label"><g:fieldValue bean="${alumnosInstance}" field="apepat"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${alumnosInstance?.apemat}">
				<li class="fieldcontain">
					<span id="apemat-label" class="property-label"><g:message code="alumnos.apemat.label" default="Apemat" /></span>
					
						<span class="property-value" aria-labelledby="apemat-label"><g:fieldValue bean="${alumnosInstance}" field="apemat"/></span>
